...
st.info("⚠️ האפליקציה פותחה למטרות לימוד ומחקר בלבד כפרויקט אישי. הנתונים המוצגים אינם מהווים ייעוץ השקעות, המלצה, או שידול לביצוע פעולות בניירות ערך. יש להיוועץ בבעל רישיון מתאים לפני קבלת החלטות השקעה.")
